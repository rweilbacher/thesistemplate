...
* Even though hardware virtualization extensions aren't necessary to make the VM work in the first place, they are very effective at blocking the VM from doing things it shouldn't. Like preventing access to special registers or certain instructions % (reference the ARM manual https://static.docs.arm.com/ddi0487/da/DDI0487D_a_armv8_arm.pdf?_ga=2.107188996.763906419.1543418758-795050915.1528805110 let them prove me wrong)
