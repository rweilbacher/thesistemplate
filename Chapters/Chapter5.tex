...
* Requires the source code to be available and legally modifiable
* BSP and adding, changing functionality
* alternative is enlisting the dev to do it
...
\paragraph{What tools are available for the creation of hypervisor images?}
Ultimately, both the business code and the hypervisor code need to be compiled and combined into an image that can be deployed on the device. 
